...
RegisterNetEvent('disc-inventoryhud:bag')
AddEventHandler('disc-inventoryhud:bag', function()
    ESX.TriggerServerCallback('disc-inventoryhud:GetLastSlot', function(slot)
        ESX.TriggerServerCallback('disc-inventoryhud:getUniq', function(uniq)
